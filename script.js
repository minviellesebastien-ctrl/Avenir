...
function renderSettings() {
  ...
  accounts.forEach((account, index) => {
    ...
    deleteButton.addEventListener("click", async () => {
      ...
      // Ajustement de la référence pour ignorer la suppression de ce compte dans la variation
      const removedAmount = parseAmount(accounts[currentIndex].amount);
      const currentRef = getEvolutionReference();
      localStorage.setItem(EVOLUTION_REFERENCE_KEY, String(currentRef - removedAmount));
